...
> 零基础转行 AI 应用开发工程师 | 杭州 · 电商/AI 方向
> 开始日期: 2026-05-21 | 目标: 金九银十拿下 offer
...
| 文件                  | 用途                          |
| ------------------- | --------------------------- |
| `[[plan]]`          | 4 个月入职路线图（技术栈、阶段性目标、信息摄入习惯） |
| `[[progress]]`      | 每日/每周进度、产出记录、收入与面试追踪        |
| `[[knowledge]]`     | 知识点存档 + 踩坑记录（每天更新）          |
| `[[resources]]`     | 学习资源库（项目、文档、博客、视频、播客）       |
| `[[advanced-plan]]` | 进阶双线计划（通用进阶 + 电商/接单/求职定制）   |
